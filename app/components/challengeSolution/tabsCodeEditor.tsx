...
import { DescriptionIcon, CodeIcon, CopiedTick, CopyIcon, ReloadIcon, FullScreenIcon } from '../../helpers/Icons';
import SettingsCodeEditor from './SettingsCodeEditor';
import { DataContext } from '../../context/dataContext';

export default function TabsCodeEditor(props) {
    const { onTabChange, prettifyCode, resetCode, copyCode, setFullScreen, isClipBoardClicked, submittedCode } = props;
    const isSolutionSubmitted = typeof submittedCode === 'string';
